...
function AreaChartWidget({ config, data }) {
        ...
        return (
            <div className="widget-card">
                <div className="widget-card-header">
                    <span className="widget-title">{title || "Area Chart"}</span>
                </div>
            ...
            <div style={{ flex: 1, minHeight: 0, overflow: "auto", display: "flex" }}>
                <div style={{ width: `${zoom * 100}%`, height: `${zoom * 100}%`, minWidth: "100%", minHeight: "100%" }}>
                    ...
                    <AreaChart data={chartData} margin={{ top: 8, right: 16, left: 0, bottom: 4 }}>
                        ...
                        <Area type="monotone" dataKey={dataKey} stroke={color} strokeWidth={2.5} fill={`url(#areaGrad-${title})`} dot={{ fill: color, r: 3 }}>
