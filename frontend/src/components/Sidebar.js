...
import "./Sidebar.css"; // We'll add corresponding css
  ...
  return (
    <aside className="sidebar">
      ...
      <nav className="sidebar-nav">
        ...
        <NavLink to="/configure" className={({ isActive }) => "sidebar-link" + (isActive ? " active" : "")}>
        ...
        <NavLink to="/workflows" className={({ isActive }) => "sidebar-link" + (isActive ? " active" : "")} end>
        ...
        <NavLink to="/workflows/logs" className={({ isActive }) => "sidebar-link" + (isActive ? " active" : "")}>
